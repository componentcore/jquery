//<![CDATA[
    ...
    // Our goal is to reduce redundent data entry through calendar data exchange.
    // This message must remain in your script.  Thanks!
...
//                });
            ...
            $('.showMoreEvents').live('click', function () {
                $('.showMoreEvents').hide();
                $('.hiddenDateRow').show();
                $('.hiddenEventRow').show();
            });
